...
namespace KompasBySajra.Controllers
{
    public class ZahtjevZaUdomljavanjeController : Controller
    {
        ...
        public ZahtjevZaUdomljavanjeController(DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,grad,adresa,imaPsa")] ZahtjevZaUdomljavanje zahtjevZaUdomljavanje)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,grad,adresa,imaPsa")] ZahtjevZaUdomljavanje zahtjevZaUdomljavanje)
        {
            if (id != zahtjevZaUdomljavanje.ID)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!ZahtjevZaUdomljavanjeExists(zahtjevZaUdomljavanje.ID))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.ZahtjevZaUdomljavanje.Any(e => e.ID == id);
        }
    }
}
